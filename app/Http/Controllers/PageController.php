...
class PageController extends Controller
{
    ...
    public function findTalents(): Response
    {
        ...
        $talents = User::where('profile_completed', '>=', 35)
            ...
            ->get()
            ->map(function($user) {
                // FIX: Get skills from relationship properly
                $skills = [];
    ...
    /**
     * Display Jobs page with filtering.
     */
    ...
    /**
     * Display Jobs with advanced filtering.
     */
    public function index(Request $request) // ← FIXED: Added Request type hint
    {
        $query = Job::query();
