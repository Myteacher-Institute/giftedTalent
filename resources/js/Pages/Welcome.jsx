...
export default function Welcome({ auth, laravelVersion, phpVersion, jobs = [], featuredTalents = [] }) {
    ...
    useEffect(() => {
        ...
        const prevBtn = document.querySelector('.talent-swiper-prev');
        const nextBtn = document.querySelector('.talent-swiper-next');
                                                        ...
                                                        <img
                                                            ...
                                                            onError={(e) => {
                                                                ...
                                                                if (parent) {
                                                                    ...
                                                                    initialDiv.className = 'company-initial';
                                                                    initialDiv.textContent = job.company_name?.charAt(0)?.toUpperCase() || 'C';
                                                    ...
                                                    {talent.profile_image_base64 || talent.avatar_url || talent.avatar ? (
                                                        <img
                                                            ...
                                                            onError={(e) => {
                                                                ...
                                                                if (parent) {
                                                                    const initialDiv = document.createElement('div');
                                                                    initialDiv.className = 'feature-talent-avatar-initials';
                                                                    initialDiv.textContent = getInitials(talent.name);
                                                                    parent.appendChild(initialDiv);
                                                                }
                                                            }}
                                                        />
