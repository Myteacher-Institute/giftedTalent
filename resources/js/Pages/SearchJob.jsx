...
export default function SearchJob({ auth, profile, recommendedJobs = [], exploreJobs = [], savedJobs: initialSavedJobs = [] }) {
    ...
    const [savedJobs, setSavedJobs] = useState(initialSavedJobs.map(job => job.id || job));
    ...
    useEffect(() => {
        const newAllJobs = [...recommendedJobs, ...exploreJobs];
        setJobs(newAllJobs);
        setFilteredJobs(newAllJobs);
    ...
    useEffect(() => {
        if (currentUser?.skills && jobs.length > 0) {
            const percentages = {};
            const userSkills = currentUser.skills.map(s => s.name?.toLowerCase() || s.toLowerCase());
        ...
        <AuthenticatedLayout user={auth.user}>
            ...
            <nav className="navbar">
                ...
                <div className="nav-right">
                    ...
                    <img src={getProfileImageUrl()} alt="User avatar" className="avatar" />
                </div>
            </nav>
            ...
            <div className="container">
                ...
                <div className="left">
                    ...
                    <div className="profile-card">
                        ...
                        <img src={getProfileImageUrl()} alt="profile" className="profile-img" />
