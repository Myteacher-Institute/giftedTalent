        ...
        <>
            ...
            <div className="about-page">
                ...
                <section className="about-story">
                    <div className="story-container">
                        <div className="story-image">
                            <img src="/assets/img/giftedtalentimage.png" alt="Our Story" />
                        </div>
                        <div className="story-text">
                            <h2>Our Story</h2>
                            <p>GiftedTalents was born from a simple idea: connecting talented professionals with companies that need them shouldn't be complicated. Founded in 2020, we set out to create a platform that puts people first.</p>
                            <p>Today, we've helped thousands of professionals find meaningful work and hundreds of companies build exceptional teams. Our journey is just beginning, and we're excited to continue growing with our community.</p>
                            <Link href="/how-it-works" className="story-btn">Learn How It Works</Link>
                        </div>
                    </div>
